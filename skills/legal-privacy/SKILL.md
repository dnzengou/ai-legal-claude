...
description: "Scans a website URL to detect actual data collection practices, then generates a comprehensive GDPR and CCPA compliant privacy policy tailored to what the site actually does. Covers cookies, analytics, third-party services, user rights, and data retention."
command: /legal privacy <url>
---
