...
description: "Flagship contract review: launches 5 parallel AI agents to score every clause, flag risks, check compliance, map obligations, and generate prioritized recommendations. Returns a Contract Safety Score (0-100) and a complete CONTRACT-REVIEW.md report."
